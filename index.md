...
- Actividades ilegales según legislación española o europea  
- DDoS o ataques a terceros  
- Minería de criptomonedas no autorizada  
- Malware, phishing o software malicioso  
- Spam o abuso de red  
...
Los reembolsos solo se concederán en caso de fallo grave del servicio imputable a Avedore Cloud.
...
Avedore Cloud no realiza backups automáticos por defecto. El Cliente es responsable de sus propios backups.

Cuando existan backups disponibles:

- Se realizan mensualmente  
- No están garantizados  
- Su restauración no está asegurada  
...
En planes S se permite uso dedicado, manteniendo límites razonables de tráfico de red.

Se considera uso abusivo:

- Uso continuo excesivo de CPU  
...
- DDoS o ataques desde/hacia el servidor  
...
Tras la cancelación del servicio, los datos se eliminarán en un plazo de 3 días.
...
Avedore Cloud puede suspender o cancelar servicios en caso de:
